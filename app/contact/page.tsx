                    ...
                    return (
                        <div key={index} className="masker">
                            <div className="w-fit flex">
                                ...
                                {index === 0 && (<motion.div initial={{width: 0}} animate={{width: "8.75vw"}} transition={{ease: [0.74, 0, 0.24, 1], duration: 1}} className='mr-[1vw] rounded-md w-[8.75vw] bg-red-400 relative top-[1.2vw] h-[5.5vw]'></motion.div>)}
