...
function Footer() {
  return (
    ...
    <div className='w-full h-screen p-20 flex font1'>
      ...
      <div className='w-1/2 mr-5 h-full flex flex-col'>
        ...
        <div className="debt flex flex-col mt-28 leading-none text-[1.1vw] font-light font2">
            <div className='uppercase mb-5'>S:</div>
            {["Instagram", "Twitter", "Linkdln", "GitHub"].map((item, index) =>(
                <a key={index} className={`underline gap-9 capitalize font-light py-2`}>{item}</a>
            ) )}
        </div>
        <div className="debt flex flex-col mt-20 leading-none text-[1.1vw] font-light font2">
