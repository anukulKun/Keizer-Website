...
function Marque() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed=".032" className=' w-full py-24 bg-[#004D43] rounded-tl-3xl rounded-tr-3xl text-white'>
        ...
        ">
            <motion.h1 initial={{x: 0}} animate={{x:"-100%"}} transition={{repeat:Infinity, ease: "linear", duration: 10}} className='text-[24vw] leading-[0.6] font1 uppercase pr-20'>We are Keizer</motion.h1>
            <motion.h1 initial={{x: 0}} animate={{x:"-100%"}} transition={{repeat:Infinity, ease: "linear", duration: 10}} className='text-[24vw] leading-[0.6] font1 uppercase pr-20'>We are Keizer</motion.h1>
